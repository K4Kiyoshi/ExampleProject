...
const ShortListedClickModel = (props) => {
  const {
    show,
    closeBtn,
    mainTable,
                ...
                <table className="templateListss-tabless main-table">
                  <thead className="text-center">
                    <tr>
                      {detailStatus == false && (
                        <>
                          <th style={{ width: 50, borderLeftColor: "none" }}>
                            <input
                              type="CheckBox"
...
export default ShortListedClickModel;
