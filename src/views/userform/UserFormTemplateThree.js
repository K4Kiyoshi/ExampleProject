...
const UserFormTemplateThree = (props) => {
  ...
  return (
    <div style={{ overflow: "hidden" }}>
      ...
      <CRow>
        <CCol lg="2" sm="0" xs="0"></CCol>
        <CCol lg="8" sm="12" xs="12">
          <CRow style={{ border: "1px solid #E8E8E8", boxShadow: "5px 10px #F5F5F5", marginBottom: "80px" }}>
            <CCol lg="5" md="5" sm="5" xs="5" className="word-break">
              <>
                <CRow className="templateThree mr-0 headerColumn" style={{ marginBottom: "30px" }}></CRow>
            ...
            <CCol lg="7" md="7" sm="7" xs="7" className="word-break" style={{ paddingTop: "30px", position: "relative" }}>
                ...
                >
                  {!editstatus && (
                    <>
                      ...
                      <CButton className="userform-btn" onClick={SaveData} style={{ backgroundColor: "#8993ef" }}>
                        Save
                      </CButton>
                    </>
                  )}
              ...
              <CRow className="templateThree resposive-bottom ml-0" style={{ marginRight: "0px", position: "absolute", bottom: "0", left: "0", right: "0" }} ></CRow>
            </CCol>
          </CRow>
        </CCol>
        <CCol lg="2" sm="0" xs="0"></CCol>
...
export default UserFormTemplateThree;